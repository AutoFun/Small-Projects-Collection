...
public class MyhdFrm implements ActionListener {	
	String cksql="select actions.*,clbname from actions,clubsinfo where clubsinfo_id=clubsinfo.id and clubsinfo.id in (select clubsinfo_id from clbmember where students_id="+MainFrm.uid+")";
	JFrame w;
