var closableTab = {
	...
	addTab:function(tabItem){ //tabItem = {id,name,url,closable}
		...
		if(!$('#'+id)[0]){
			var li_tab = '<li oncontextmenu="rightMenu(this)" role="presentation" value="'+tabItem.id+'" class="" id="'+id+'"><a href="#'+container+'"  role="tab" data-toggle="tab" style="position: relative;padding:2px 20px 2px 15px">'+tabItem.name;
			if(tabItem.closable){
		 	...
		 	var tabpanel = '<div role="tabpanel" class="tab-pane" id="'+container+'" style="width: 100%;height: 100%;padding-top: 5px;padding-left: 0px;padding-bottom: 0px;padding-right: 5px;">'+
